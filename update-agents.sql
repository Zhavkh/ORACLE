...
-- Update agents with descriptions and owner wallets
UPDATE agents SET owner_wallet_id = 'alex_dev.near', description = 'Autonomous trading agent for Binance and Bybit. Uses GPT-4 to analyze order flow, detect whale movements and execute positions with dynamic stop-loss management. Avg monthly return: 12-18%.' WHERE name = 'gpt_trader_v2';
UPDATE agents SET owner_wallet_id = 'neural_mike.near', description = 'AI software engineer that reads GitHub issues, writes production-ready code and opens pull requests automatically. Supports Python, TypeScript and Rust. Used by 3 YC startups.' WHERE name = 'devin_lite';
UPDATE agents SET owner_wallet_id = 'crypto_sarah.near', description = 'Customer support agent trained on your documentation. Handles tickets, escalates edge cases and syncs with Zendesk or Intercom. Reduces support load by 60% on average.' WHERE name = 'support_gpt';
UPDATE agents SET owner_wallet_id = 'defi_pablo.near', description = 'Monitors ArXiv daily, summarizes new AI and crypto papers and sends Telegram and Slack digests. Filters by topic, citation count and author reputation.' WHERE name = 'arxiv_digest';
UPDATE agents SET owner_wallet_id = 'ai_marco.near', description = 'Security agent that monitors your NEAR wallet 24/7 for suspicious transactions, phishing attempts and unusual patterns. Sends instant Telegram alerts with risk score.' WHERE name = 'near_wallet_guard';
UPDATE agents SET owner_wallet_id = 'alex_dev.near', description = 'Tracks whale wallets on NEAR and Ethereum in real time. Sends alerts when large transfers occur and generates daily on-chain reports with market impact analysis.' WHERE name = 'onchain_analyst';
UPDATE agents SET owner_wallet_id = 'crypto_sarah.near', description = 'AI sales agent that qualifies leads from your CRM, writes personalized follow-ups and books meetings automatically. Integrates with HubSpot, Salesforce and Pipedrive.' WHERE name = 'sales_autopilot';
UPDATE agents SET owner_wallet_id = 'neural_mike.near', description = 'Audits Rust and Solidity smart contracts for vulnerabilities. Generates a detailed security report with severity ratings and fix suggestions in under 60 seconds.' WHERE name = 'smart_contract_auditor';
UPDATE agents SET owner_wallet_id = 'defi_pablo.near', description = 'Scans crypto news from 50+ sources in real time and executes trades based on sentiment analysis and momentum signals. Supports Binance, OKX and Bybit.' WHERE name = 'news_trader_bot';
UPDATE agents SET owner_wallet_id = 'ai_marco.near', description = 'Reads PDFs, Notion pages, Google Docs and Confluence. Produces concise summaries, action items and key decisions for your team in seconds.' WHERE name = 'doc_summarizer';
UPDATE agents SET owner_wallet_id = 'neural_mike.near', description = 'Generates and schedules posts for Twitter, LinkedIn and Telegram based on your brand voice, trending topics and competitor analysis. Grows following by 20-40% monthly.' WHERE name = 'social_manager_ai';
UPDATE agents SET owner_wallet_id = 'crypto_sarah.near', description = 'Monitors your crypto portfolio 24/7 and automatically rebalances allocations based on your target strategy, market conditions and risk tolerance.' WHERE name = 'portfolio_rebalancer';

-- Insert reviews with separate reviewer_wallet_id column
INSERT INTO reviews (agent_id, reviewer_wallet_id, score, comment) VALUES
